...
export default {
    ...
    methods: {
        ...
        formatSpikeDataPointDetail() {
            ...
            this.datasetsSpikePointPercent = [spike_point_detail.in, spike_point_detail.fake, spike_point_detail.blockout];
        },
        formatSpikeDataMissDetail() {
            this.labelsSpikeMissPercent = ["ネット", "アウト", "ブロック"];
            var spike_miss_detail = this.spikeData.miss_detail;
            this.datasetsSpikeMissPercent = [spike_miss_detail.net, spike_miss_detail.out, spike_miss_detail.block];
        }
    }
};
</script>
