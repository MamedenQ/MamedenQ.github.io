...
export default {
    ...
    methods: {
        ...
        formatTotalDataPointDetail() {
            this.labelsTotalPointPercent = ["サーブポイント", "スパイクポイント", "ブロックポイント"];
            this.datasetsTotalPointPercent = [this.serveData.point, this.spikeData.point, this.blockData.point];
        },
        formatTotalDataMissDetail() {
            this.labelsTotalMissPercent = ["サーブミス", "スパイクミス", "ブロックミス", "レシーブミス", "ジャッジミス", "お見合い", "ファウル"];
