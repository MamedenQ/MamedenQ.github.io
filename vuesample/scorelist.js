...
<div class="main-area">
    ...
    <!--
        ...
        -->
            <button v-on:click="linkAnalyzeList" class="btn btn-primary" style="width:100%;margin-bottom:10px">選択した試合を対象に分析する</button>
            <table class="analyze">
            ...
            <button v-on:click="linkAnalyzeList" class="btn btn-primary" style="width:100%;margin-top:10px;margin-bottom:10px">選択した試合を対象に分析する</button>
